...
VAULT = Path("/data/business/hca-daily/assets/accelerator")
SRC = VAULT / "HCA-Career-Accelerator-COMPLETE.md"
OUT = VAULT / "accelerator-print.html"
...
<title>The HCA Career Accelerator</title>
